...
use crate::client_keys::generate_keypair;
use crate::components::ui::{Button, ButtonVariant, Card, CardBody, CardHeader, InputType, TextInput};
use crate::Route;
use forumall_shared::{try_problem_detail, validate_resource_name, ApiError, LoginResponse, RegisterRequest};
                    ...
                    CardBody {
                        ...
                        form {
                            ...
                            onsubmit: move |e| async move {
                                ...
                                // Perform registration with atomic device key registration
                                ...
                                match client.post_json::<RegisterRequest, LoginResponse>(&register_url, &req).await {
                                    ...
                                    Err(ApiError::Http { status, body }) => {
                                        let msg = try_problem_detail(&body).unwrap_or(body);
