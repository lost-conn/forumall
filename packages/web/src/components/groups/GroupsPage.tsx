...
import { canCreateGroups } from "../../stores/branding.ts";
              ...
              <Show
                ...
                fallback={
                  ...
                  >
                    ...
                    <Show
                      when={canCreateGroups()}
                      fallback={
                        <p class="mt-2 text-xs text-faint" data-testid="create-group-restricted">
                          New spaces can only be created by the provider admin on this instance.
                        </p>
                      }
                    >
                      <button
